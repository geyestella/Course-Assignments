...
def generate(data, d,n):
    ...
    np.savetxt('index52.csv', TransactIndex, fmt='%f', delimiter=',')
    np.savetxt('return52.csv', Return, fmt='%f', delimiter=',')
    '''
